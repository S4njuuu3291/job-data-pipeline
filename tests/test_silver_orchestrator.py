...
class TestTransformSilver:
    ...
    def sample_bronze_dataframe(self):
        ...
        return pd.DataFrame({
            ...
            "location": ["jakarta selatan", "bandung", "yogyakarta"],  # Non-normalized
    ...
    def test_transform_silver_success(
        ...
        mock_upload.return_value = "ingestion_date=2026-03-05/job_data_2026-03-05.parquet"
...
class TestRunPipeline:
    ...
    def test_run_pipeline_success(
        ...
        assert result["object_key"] == "ingestion_date=2026-03-05/job_data_2026-03-05.parquet"
